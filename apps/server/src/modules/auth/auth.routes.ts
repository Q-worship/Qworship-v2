...
import { signIn, signUp, verifyEmail, resendVerification, requestPasswordReset, resetPassword, updateProfile, updatePassword, getBiblePreferences, updateBiblePreferences, extendSelfTrial } from './auth.controller.js';
