...
export function GuideModal({ isOpen, onClose }: GuideModalProps) {
  ...
  return (
    <div
      ...
      onClick={onClose}
      data-testid="modal-guide"
    >
      <div
        className="w-full max-w-5xl h-[85vh] max-h-[820px] bg-[#131419] rounded-2xl overflow-hidden flex flex-col shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Navbar */}
        <header className="flex items-center justify-between px-6 py-3 bg-[#131419] border-b border-white/5 flex-shrink-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, #8B5CF6, #131419, #61459D, #CEA2FD, #61459D, #131419, #8B5CF6)",
          }}
        >
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <main className="flex-1 overflow-y-auto p-8">
            {activeTopic === "ndi-bridge" && (
              <>
                <h1 className="text-[#CEA2FD] text-2xl font-bold mb-1.5">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                    ...
                    {installTab === "windows" ? (
                      ...
                      <p className="text-xs text-slate-400 leading-relaxed">
                        ...
                        the Browser Source Links above directly as a Browser Source in OBS,
                        vMix, or another NDI-compatible application.
                      </p>
                    )}
